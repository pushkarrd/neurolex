...
export default function HandwritingPage() {
        ...
        try {
            ...
            if (user?.uid) {
                logHandwritingUpload(user.uid, {
                    ...
                    errors: (data.errors || []).map((e: any) => e.type || e.category || 'unknown'),
                });
            }
        } catch (err: any) {
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="max-w-5xl mx-4 sm:mx-auto py-8 content-blur-card p-4 sm:p-8 mt-4">
                        ...
                        <div className="rounded-2xl p-5 bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="reading-content text-foreground/60 text-sm">
                            ...
                            {imagePreview ? (
                                ...
                                <div className="flex flex-col items-center gap-4 py-8">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-foreground/40 text-sm mt-1">JPG, PNG — max 50 MB</p>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <AnimatePresence mode="wait">
                            {analyzing ? (
                                ...
                                >
                                    ...
                                    <p className="text-foreground/60">Analyzing handwriting patterns...</p>
                                    <p className="text-foreground/40 text-sm mt-2">Extracting text, checking spelling, scoring each category...</p>
                                </motion.div>
                            ) : results ? (
                                <motion.div
                                    key="results"
                                ...
                                >
                                    ...
                                    <div className="rounded-2xl p-6 bg-white/5 border border-white/10">
                                        ...
                                        <p className="text-foreground/60 text-sm">{results.summary}</p>

                                        {/* Score breakdown legend */}
                                        <div className="mt-3 pt-3 border-t border-white/5 text-xs text-foreground/30">
                                    ...
                                    {results.categoryScores && (
                                        <div className="rounded-2xl p-5 bg-white/5 border border-white/10">
                                            ...
                                            >
                                                ...
                                                {expandedSections.categories === false ? <ChevronDown size={16} className="text-foreground/40" /> : <ChevronUp size={16} className="text-foreground/40" />}
                                            </button>
                                                    ...
                                                    {[
                                                        ...
                                                        return (
                                                            <div key={key}>
                                                                ...
                                                                <p className="text-[10px] text-foreground/30 mt-0.5">{desc}</p>
                                                            </div>
                                                        );
                                                    })}
                                                </div>
                                    ...
                                    {results.extractedText && (
                                        <div className="rounded-2xl p-5 bg-white/5 border border-white/10">
                                            ...
                                            >
                                                ...
                                                {expandedSections.extracted === false ? <ChevronDown size={16} className="text-foreground/40" /> : <ChevronUp size={16} className="text-foreground/40" />}
                                            </button>
                                            {expandedSections.extracted !== false && (
                                                <div className="reading-content text-sm text-foreground/60 bg-black/20 rounded-xl p-4 whitespace-pre-wrap leading-relaxed max-h-60 overflow-y-auto">
                                    ...
                                    {results.spellingErrors && results.spellingErrors.length > 0 && (
                                        <div className="rounded-2xl p-5 bg-red-500/5 border border-red-500/20">
                                            ...
                                            >
                                                ...
                                                {expandedSections.spelling === false ? <ChevronDown size={16} className="text-foreground/40" /> : <ChevronUp size={16} className="text-foreground/40" />}
                                            </button>
                                            {expandedSections.spelling !== false && (
                                                <div className="space-y-2">
                                                    {results.spellingErrors.map((se: any, i: number) => (
                                                        <div key={i} className="flex items-center gap-3 text-sm p-2 rounded-lg bg-black/20">
                                                            ...
                                                            <span className="text-[10px] px-2 py-0.5 rounded-full bg-white/10 text-foreground/40 ml-auto">
                                    ...
                                    {results.errors && results.errors.length > 0 && (
                                        <div className="rounded-2xl p-5 bg-white/5 border border-white/10">
                                            ...
                                            >
                                                ...
                                                {expandedSections.errors === false ? <ChevronDown size={16} className="text-foreground/40" /> : <ChevronUp size={16} className="text-foreground/40" />}
                                            </button>
                                                                ...
                                                                <div className="flex-1">
                                                                    ...
                                                                    {err.word && (
                                                                        <div className="mt-1 text-xs">
                                                                            <span className="text-foreground/40">Found: </span>
                                ...
                                <motion.div
                                    ...
                                    style={{ minHeight: '400px' }}
                                >
                                    <PenTool size={48} className="text-foreground/20 mb-4" />
                                    <p className="text-foreground/40">Upload a handwriting image to see analysis results</p>
...
function highlightExtractedText(text: string, spellingErrors: any[]) {
